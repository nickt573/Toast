// Notebooks as SRS groups is deprecated, some backend support remains but the UI no longer
// exposes it
...
// Newer macOS composites a bundled icns icon onto a grey squircle, so setting it at runtime
// the way tauri dev does makes the Dock and app switcher show the PNG as it is
#[cfg(target_os = "macos")]
fn set_dock_icon() {
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::todos::set_todo_skipped,
            ...
            commands::groups::duplicate_deck,
            ...
            commands::groups::duplicate_notebook,
            ...
            commands::stats::bulk_delete_todo_stats,
            commands::stats::bulk_update_todo_stats,
            ...
            commands::units::add_variant,
            commands::units::rename_variant,
            commands::units::set_main_variant,
            commands::units::merge_units,
            commands::units::delete_variant,
